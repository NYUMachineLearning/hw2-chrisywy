...
ggplot(data = predvstest.l) + geom_point(aes(x=Month+Day/31, y=lasso_predict),color = "red") + geom_point(aes(x=Month+Day/31, y=Temp),color = "blue") +xlab("Month (Date)") + ylab("Predicted (Red) and Real (Blue) Temp") + theme_bw()
...
ggplot(data = predvstest.r) + geom_point(aes(x=Month+Day/31, y=ridge_predict),color = "red") + geom_point(aes(x=Month+Day/31, y=Temp),color = "blue") +xlab("Month (Date)") + ylab("Predicted (Red) and Real (Blue) Temp") + theme_bw()
